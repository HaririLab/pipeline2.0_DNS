...
subDir=/mnt/BIAC/munin4.dhe.duke.edu/Hariri/DNS.01/Analysis/All_Imaging/${sub}_rerun2 #pipenotes= Change away from HardCoding later
...
3dcalc -a ${freeDir}/SUMA/brainmask.nii.gz -b ${freeDir}/SUMA/aseg.nii.gz -expr 'a*step(b)' -prefix ${tmpDir}/test.nii.gz
