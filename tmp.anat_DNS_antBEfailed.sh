...
subDir=/mnt/BIAC/munin4.dhe.duke.edu/Hariri/DNS.01/Analysis/All_Imaging/${sub}_rerun1 #pipenotes= Change away from HardCoding later
QADir=${subDir}/QA
antDir=${subDir}/antCT
...
antsRegistrationSyN.sh -d 3 -t r -f ${templateDir}/${templatePre}_Brain.nii.gz -m ${freeDir}/SUMA/brainmask.nii.gz -n $threads -o ${antDir}/${antPre}r
