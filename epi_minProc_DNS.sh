...
if [[ $task == "rest1" && $restPre2 != "not_collected" ]];then
	...
	echo "/mnt/BIAC/munin2.dhe.duke.edu/Hariri/DNS.01/Scripts/pipeline2.0_DNS/epi_minProc_DNS.sh $sub rest2 $threads >> ${subDir}/QA/LOG.rest2" >> ${tmpOutDir}/swarm.rest2
	echo ""
	echo "#########################################################################################################"
